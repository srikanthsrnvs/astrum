...
class CustomLeNet:
    ...
    def build_lenet(self):
        def create_googlenet(weights_path=None):
            ...
            loss1_classifier = Dense(self.output_classes, name='loss1/classifier', kernel_regularizer=l2(0.0002))(loss1_drop_fc)
            ...
            loss2_classifier = Dense(self.output_classes, name='loss2/classifier', kernel_regularizer=l2(0.0002))(loss2_drop_fc)
            ...
            loss3_classifier = Dense(self.output_classes, name='loss3/classifier', kernel_regularizer=l2(0.0002))(pool5_drop_7x7_s1)
